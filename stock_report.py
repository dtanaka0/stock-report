...
各銘柄を以下の形式で（CHART_PLACEHOLDERという文字列を株価チャートの場所に必ず入れてください）：
...
上記の業界トレンドとニュースをもとに、現在保有していない銘柄の中から**今注目すべき3〜5銘柄**を提案してください。

各銘柄を以下の形式で：

| 銘柄名（ティッカー） | 注目理由 | リスク | 短期期待値 |
|---|---|---|---|
| 例：SMH（半導体ETF） | 理由 | リスク | 高/中/低 |
...
## ④ 本日の総評
（5銘柄・業界動向・注目銘柄を踏まえた全体コメントを200文字程度で）
